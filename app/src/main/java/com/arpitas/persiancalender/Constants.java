...
public class Constants {
    ...
    public static final String contentRating = "adMobContentRating";
    public static final String timeout = "adMobTimeout";

    public static final String key_counter_login_user = "counterLoginUser";
    public static final String key_btn_ad = "btnAd";
    public static final String key_splash_activity_ad = "splashActivityAd";
    ...
    public static final String[] FIRST_CHAR_OF_DAYS_OF_WEEK_NAME_FA = {"ش", "ی", "د", "س",
            "چ", "پ", "ج"};

    public static final String[] FIRST_CHAR_OF_DAYS_OF_WEEK_NAME_EN = {"S", "S", "M", "T",
            "W", "T", "F"};
    ...
    public static final String AM_IN_ENGLISH = "AM";
    public static final String PM_IN_PERSIAN = "ب.ظ";
    public static final String PM_IN_ENGLISH = "PM";
    ...
    public static final String key_ad_event_click_submit_event = "adEventClickSubmitEvent";
